    ...
    <>
      <div className="head flex flex-wrap text-auto justify-between">
        <div className={styles.head}>
          <h1 className="flex  flex-wrap">
            Ma feuille de temps |{" "}
            <p className="text-blue-500"> &nbsp; Vue Hebdomadaire</p>
          </h1>
        ...
        <div className={styles.btn}>
          <div className="flex justify-evenly flex-wrap text-xs">
            <button className="px-3 mt-1 py-2 bg-blue-500 text-white rounded mr-2">
              Basuler vers la vue Mensuelle
            </button>
            <button className="px-3 mt-1 py-2 bg-blue-500 text-white rounded mr-2">
              Bouton Modifier / Enregistrer
            </button>
          </div>
          <h1 className=" mt-2 text-center text-xs">
      ...
      <div className="min-w-max">
        <div className=" bg-blue-300 flex px-3 mt-5 tableau border  text-sm py-2">
          ...
          <div className="w-[100px] border-gray-600 text-center border-r">
            Lundi
          </div>
          <div className="w-[100px] border-gray-600 text-center border-r">
            Mardi
        ...
        <div className="flex px-3 tableau border text-sm ">
          ...
          <div className="w-[100px] text-center border-r py-1">1</div>
          <div className="w-[100px] text-center border-r py-1">1</div>
          <div className="w-[100px] text-center border-r py-1">1</div>
          <div className="w-[100px] text-center border-r py-1">1</div>
          <div className="w-[100px] text-center border-r py-1">1</div>
          <div className="w-[200px] text-center py-1">5</div>
        </div>
        <div>
